...
public interface Visitor<T> {
	...
	T visitForStmt(Variable var, Exp exp, Block forBlock);
	...
	T visitDictGet (Exp dict, Exp key);

	T visitDictDel (Exp dict, Exp key);

	T visitDictPut(Exp dict, Exp key, Exp value);
	
	T visitDictCons (Exp key, Exp value);
}
